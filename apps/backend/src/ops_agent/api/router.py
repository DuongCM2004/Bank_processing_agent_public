...
from ops_agent.api.routes.document_extraction import router as document_extraction_router
...
from ops_agent.api.routes.processing import router as processing_router

api_router = APIRouter()
api_router.include_router(audit_router)
api_router.include_router(cases_router)
api_router.include_router(decisions_router)
api_router.include_router(document_extraction_router)
